...
# Egyszerű "tudásbázis" példákhoz – ezt lehet bővíteni
KB = [
    {
        "code": "E221",
...
st.markdown("---")
st.caption(
    "Ez a prototípus csak szemléltetésre szolgál. Valós szervizelésnél mindig kövesd a hivatalos ENGEL "
    "dokumentációkat és a belső vállalati szabályzatokat, és emberi szakember hozzon döntést."
)
